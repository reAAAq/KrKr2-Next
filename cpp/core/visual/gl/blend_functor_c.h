...
struct alpha_blend_a_functor {
    ...
    inline tjs_uint32 operator()(tjs_uint32 d, tjs_uint32 s) const { return blend_(d, topremulalpha_(s)); }
};
//------------------------------------------------------------------------------
...
struct color_copy_functor {
    inline tjs_uint32 operator()(tjs_uint32 d, tjs_uint32 s) const { return (d & 0xff000000) + (s & 0x00ffffff); }
};
// alphaだけコピーする : color_copy の src destを反転しただけ
struct alpha_copy_functor {
    inline tjs_uint32 operator()(tjs_uint32 d, tjs_uint32 s) const { return (s & 0xff000000) + (d & 0x00ffffff); }
};
...
struct ps_mul_blend_func : public ps_alpha_blend_func {
    inline tjs_uint32 operator()(tjs_uint32 d, tjs_uint32 s, tjs_uint32 a) const {
        s = (((((d >> 16) & 0xff) * (s & 0x00ff0000)) & 0xff000000) |
             ((((d >> 8) & 0xff) * (s & 0x0000ff00)) & 0x00ff0000) | ((((d >> 0) & 0xff) * (s & 0x000000ff)))) >>
            8;
        return ps_alpha_blend_func::operator()(d, s, a);
    }
};
...
struct ps_screen_blend_func {
    inline tjs_uint32 operator()(tjs_uint32 d, tjs_uint32 s, tjs_uint32 a) const {
        ...
        tjs_uint32 sd1, sd2;
        sd1 = (((((d >> 16) & 0xff) * (s & 0x00ff0000)) & 0xff000000) | ((((d >> 0) & 0xff) * (s & 0x000000ff)))) >> 8;
...
struct ps_overlay_blend_func : public ps_alpha_blend_func {
    inline tjs_uint32 operator()(tjs_uint32 d, tjs_uint32 s, tjs_uint32 a) const {
        ...
        s |= 0x00010101;
        sa1 = (((((d >> 16) & 0xff) * (s & 0x00ff0000)) & 0xff800000) | ((((d >> 0) & 0xff) * (s & 0x000000ff)))) >> 7;
...
struct sd_const_alpha_blend_a_functor {
    ...
    inline tjs_uint32 operator()(tjs_uint32 s1, tjs_uint32 s2) const { return blend_(s1, s2, opa_); }
};
struct const_alpha_blend_a_functor {
    const tjs_int32 opa_;
    premulalpha_blend_a_a_func blend_;
    inline const_alpha_blend_a_functor(tjs_int32 opa) : opa_(opa << 24) {}
    inline tjs_uint32 operator()(tjs_uint32 s1, tjs_uint32 s2) const { return blend_(s1, (s2 & 0xffffff) | opa_); }
};
struct sd_const_alpha_blend_d_functor {
    const tjs_int32 opa_;
    const tjs_int32 iopa_;
    inline sd_const_alpha_blend_d_functor(tjs_int32 opa) :
        opa_(opa > 127 ? opa + 1 : opa), iopa_(opa > 127 ? 255 - opa : 256 - opa) {}
    inline tjs_uint32 operator()(tjs_uint32 s1, tjs_uint32 s2) const {
        tjs_uint32 a1 = s1 >> 24;
        tjs_uint32 a2 = s2 >> 24;
...
struct const_alpha_blend_d_functor {
    ...
    inline tjs_uint32 operator()(tjs_uint32 d, tjs_uint32 s) const {
        ...
        tjs_uint32 alpha = TVPOpacityOnOpacityTable[addr];
        tjs_uint32 d1 = d & 0xff00ff;
        d1 = ((d1 + (((s & 0xff00ff) - d1) * alpha >> 8)) & 0xff00ff) + (TVPNegativeMulTable[addr] << 24);
        d &= 0xff00;
        s &= 0xff00;
...
struct const_color_copy_functor {
    ...
    inline tjs_uint32 operator()(tjs_uint32 d) const { return (d & 0xff000000) + color_; }
};
struct const_alpha_copy_functor {
    const tjs_uint32 alpha_;
    inline const_alpha_copy_functor(tjs_uint32 a) : alpha_(a << 24) {}
    inline tjs_uint32 operator()(tjs_uint32 d) const { return (d & 0x00ffffff) + alpha_; }
};
struct const_alpha_fill_blend_functor {
    ...
    inline const_alpha_fill_blend_functor(tjs_int32 opa, tjs_int32 color) :
        opa_(255 - opa), color_((color & 0xff00ff) * opa), color_mid_((color & 0xff00) * opa) {}
    inline tjs_uint32 operator()(tjs_uint32 d) const {
        return (d & 0xff000000) + ((((d & 0xff00ff) * opa_ + color_) >> 8) & 0xff00ff) +
...
struct const_alpha_fill_blend_a_functor {
    ...
    inline const_alpha_fill_blend_a_functor(tjs_int32 opa, tjs_int32 color) :
        ...
        opa_inv_(opa ^ 0xff) {}
    inline tjs_uint32 operator()(tjs_uint32 d) const { return func_(d, opa_, opa_inv_, color_); }
};
//--------------------------------------------------------------------------------------------------------
template <int tshift>
...
struct apply_color_map_xx_a_functor {
    ...
    inline tjs_uint32 operator()(tjs_uint32 d, tjs_uint8 s) const {
        tjs_int s_tmp = s;
        tjs_uint32 tmp =
            ((s_tmp * (c1_ & 0xff00ff) >> tshift) & 0xff00ff) + ((s_tmp * (color_ & 0x00ff00) >> tshift) & 0x00ff00);
        s_tmp <<= (8 - tshift);
...
struct convet_premulalpha_to_alpha_functor {
    inline tjs_uint32 operator()(tjs_uint32 d) const {
        ...
        return (tmp & 0xff000000) + (t[(tmp >> 16) & 0xff] << 16) + (t[(tmp >> 8) & 0xff] << 8) + (t[tmp & 0xff]);
    }
};
...
struct bind_mask_to_main_functor {
    inline tjs_uint32 operator()(tjs_uint32 c, tjs_uint8 a) const { return (c & 0xffffff) | (a << 24); }
};
