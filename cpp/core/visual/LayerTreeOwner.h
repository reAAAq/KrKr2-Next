...
public:
    ...
    virtual void TJS_INTF_METHOD NotifyBitmapCompleted(class iTVPLayerManager *manager, tjs_int x, tjs_int y,
    ...
    virtual void TJS_INTF_METHOD SetAttentionPoint(class iTVPLayerManager *manager, class tTJSNI_BaseLayer *layer,
