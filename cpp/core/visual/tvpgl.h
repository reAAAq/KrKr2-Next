...
static tjs_uint32 TVP_INLINE_FUNC TVPAddAlphaBlend_n_a(tjs_uint32 dest, tjs_uint32 src) {
    ...
    return TVPSaturatedAdd((((dest & 0xff00ff) * sopa >> 8) & 0xff00ff) + (((dest & 0xff00) * sopa >> 8) & 0xff00),
                           src);
}
...
static tjs_uint32 TVP_INLINE_FUNC TVPAddAlphaBlend_a_a(tjs_uint32 dest, tjs_uint32 src) {
    ...
    */
    ...
    src &= 0xffffff;
    return (dopa << 24) +
        TVPSaturatedAdd((((dest & 0xff00ff) * sopa >> 8) & 0xff00ff) + (((dest & 0xff00) * sopa >> 8) & 0xff00), src);
}

static tjs_uint32 TVP_INLINE_FUNC TVPAddAlphaBlend_a_ca(tjs_uint32 dest, tjs_uint32 sopa, tjs_uint32 sopa_inv,
                                                        tjs_uint32 src) {
    /*
            Di = sat(Si, (1-Sa)*Di)
            Da = Sa + Da - SaDa
    */
    ...
    dopa -= (dopa >> 8); /* adjust alpha */
    return (dopa << 24) +
        TVPSaturatedAdd((((dest & 0xff00ff) * sopa_inv >> 8) & 0xff00ff) + (((dest & 0xff00) * sopa_inv >> 8) & 0xff00),
                        src);
}
...
TVP_GL_FUNC_PTR_EXTERN_DECL(void, TVPInterpLinTransAdditiveAlphaBlend,
                            (tjs_uint32 * dest, tjs_int destlen, const tjs_uint32 *src, tjs_int sx, tjs_int sy,
                             tjs_int stepx, tjs_int stepy, tjs_int srcpitch));
...
TVP_GL_FUNC_PTR_EXTERN_DECL(void, TVPDoBoxBlurAvg16,
                            (tjs_uint32 * dest, tjs_uint16 *sum, const tjs_uint16 *add, const tjs_uint16 *sub,
...
TVP_GL_FUNC_PTR_EXTERN_DECL(void, TVPDoBoxBlurAvg32,
                            (tjs_uint32 * dest, tjs_uint32 *sum, const tjs_uint32 *add, const tjs_uint32 *sub,
                             tjs_int n, tjs_int len));
...
#define TVP_RGBA2COLOR(r, g, b, a) (((a) << 24) + (((r) << 16) + ((g) << 8) + (b)))
/*]*/
