...
namespace TJS {
    ...
    public:
        ...
        static iTJSDispatch2 *GetResultArray(bool matched, const tjs_char *target, tTJSNI_RegExp *_this,
                                             const OnigRegion *region);

        static iTJSDispatch2 *GetResultArray(bool matched, const ttstr &target, tTJSNI_RegExp *_this,
                                             const OnigRegion *region) {
