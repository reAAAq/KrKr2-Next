...
namespace TJS {
    ...
    //---------------------------------------------------------------------------
    typedef tjs_error(TJS_INTF_METHOD *tTJSNativeClassMethodCallback)(tTJSVariant *result, tjs_int numparams,
...
/*]*/
    ...
    /*]*/
    TJS_EXP_FUNC_DEF(tTJSNativeClassMethod *, TJSCreateNativeClassMethod, (tTJSNativeClassMethodCallback callback));
    ...
    public:
        tTJSNativeClassConstructor(tTJSNativeClassMethodCallback processfunc) : tTJSNativeClassMethod(processfunc) { ; }
    ...
    typedef tjs_error(TJS_INTF_METHOD *tTJSNativeClassPropertySetCallback)(const tTJSVariant *param,
                                                                           iTJSDispatch2 *objthis);
/*]*/
#ifdef __TP_STUB_H__
    /*[*/
...
/*]*/
    ...
    public:
        tTJSNativeClassProperty(tTJSNativeClassPropertyGetCallback get, tTJSNativeClassPropertySetCallback set);
    ...
    public:
        ...
        void RegisterNCM(const tjs_char *name, iTJSDispatch2 *dsp, const tjs_char *classname,
    ...
    inline TJS_EXP_FUNC_DEF(void, TJSNativeClassRegisterNCM,
                            (tTJSNativeClass * cls, const tjs_char *name, iTJSDispatch2 *dsp, const tjs_char *classname,
                             tTJSNativeInstanceType type, tjs_uint32 flags = 0)) {
...
#define TJS_GET_NATIVE_INSTANCE_OUTER(classname, varname, typename)                                                    \
    ...
    {                                                                                                                  \
        tjs_error hr;                                                                                                  \
        hr = objthis->NativeInstanceSupport(TJS_NIS_GETINSTANCE, classname::ClassID, (iTJSNativeInstance **)&varname); \
        if(TJS_FAILED(hr))                                                                                             \
            return TJS_E_NATIVECLASSCRASH;                                                                             \
    }
...
#define TJS_BEGIN_NATIVE_METHOD_DECL(name)                                                                             \
    struct NCM_##name {                                                                                                \
        static tjs_error TJS_INTF_METHOD Process(tTJSVariant *result, tjs_int numparams, tTJSVariant **param,          \
                                                 iTJSDispatch2 *objthis) {
...
#define TJS_END_NATIVE_METHOD_DECL(name)                                                                               \
    ...
    TJSNativeClassRegisterNCM(TJS_NCM_REG_THIS, TJS_W(#name), TJSCreateNativeClassMethod(NCM_##name::Process),         \
...
#define TJS_END_NATIVE_METHOD_DECL_OUTER(object, name)                                                                 \
    TJS_END_NATIVE_METHOD_DECL_INT                                                                                     \
    TJSNativeClassRegisterNCM((object), TJS_W(#name), TJSCreateNativeClassMethod(NCM_##name::Process),                 \
...
#define TJS_END_NATIVE_CONSTRUCTOR_DECL(name)                                                                          \
    TJS_END_NATIVE_METHOD_DECL_INT                                                                                     \
    TJSNativeClassRegisterNCM(TJS_NCM_REG_THIS, TJS_W(#name), TJSCreateNativeClassConstructor(NCM_##name::Process),    \
                              __classname, nitMethod);
...
#define TJS_END_NATIVE_PROP_DECL(name)                                                                                 \
    ...
    TJSNativeClassRegisterNCM(TJS_NCM_REG_THIS, TJS_W(#name),                                                          \
                              TJSCreateNativeClassProperty(NCM_##name::Get, NCM_##name::Set), __classname,             \
                              nitProperty);

#define TJS_END_NATIVE_PROP_DECL_OUTER(object, name)                                                                   \
    ;                                                                                                                  \
    TJSNativeClassRegisterNCM((object), TJS_W(#name), TJSCreateNativeClassProperty(NCM_##name::Get, NCM_##name::Set),  \
...
#define TJS_BEGIN_NATIVE_PROP_GETTER static tjs_error TJS_INTF_METHOD Get(tTJSVariant *result, iTJSDispatch2 *objthis) {

#define TJS_END_NATIVE_PROP_GETTER }

#define TJS_DENY_NATIVE_PROP_GETTER                                                                                    \
    static tjs_error TJS_INTF_METHOD Get(tTJSVariant *result, iTJSDispatch2 *objthis) { return TJS_E_ACCESSDENYED; }

#define TJS_BEGIN_NATIVE_PROP_SETTER                                                                                   \
    static tjs_error TJS_INTF_METHOD Set(const tTJSVariant *param, iTJSDispatch2 *objthis) {
...
#define TJS_PARAM_EXIST(num) (numparams > (num) ? param[num]->Type() != tvtVoid : false)
    ...
    protected:
        tjs_error virtual Process(tTJSVariant *result, tjs_int numparams, tTJSVariant **param,
