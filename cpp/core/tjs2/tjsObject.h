...
namespace TJS {
    ...
    // utility functions
    //---------------------------------------------------------------------------
    extern tjs_error TJSDefaultFuncCall(tjs_uint32 flag, tTJSVariant &targ, tTJSVariant *result, tjs_int numparams,
                                        tTJSVariant **param, iTJSDispatch2 *objthis);

    extern tjs_error TJSDefaultPropGet(tjs_uint32 flag, tTJSVariant &targ, tTJSVariant *result, iTJSDispatch2 *objthis);
    ...
    extern tjs_error TJSDefaultCreateNew(tjs_uint32 flag, tTJSVariant &targ, iTJSDispatch2 **result, tjs_int numparams,
                                         tTJSVariant **param, iTJSDispatch2 *objthis);

    extern tjs_error TJSDefaultIsInstanceOf(tjs_uint32 flag, tTJSVariant &targ, const tjs_char *name,
                                            iTJSDispatch2 *objthis);

    extern tjs_error TJSDefaultOperation(tjs_uint32 flag, tTJSVariant &targ, tTJSVariant *result,
...
*/
#define TJS_SELECT_OBJTHIS(__closure__, __override__) ((__closure__).ObjThis ? (__closure__).ObjThis : (__override__))
...
#define TJS_MAX_NATIVE_CLASS 4
    ...
    */
    ...
    private:
        ...
        static bool CallEnumCallbackForData(tjs_uint32 flags, tTJSVariant **params, tTJSVariantClosure &callback,
                                            iTJSDispatch2 *objthis, const tTJSSymbolData *data);

        void InternalEnumMembers(tjs_uint32 flags, tTJSVariantClosure *callback, iTJSDispatch2 *objthis);
        //---------------------------------------------------------------------
    public:
