...
public:
    ...
    tTJSString(const tTJSStringBufferLength len) // NOLINT(*-explicit-constructor)
    ...
    tTJSString(const std::basic_string<tjs_char> &str) // NOLINT(*-explicit-constructor)
    ...
    [[nodiscard]] tTJSVariantString *AsVariantStringNoAddRef() const { return Ptr; }
    ...
    [[nodiscard]] tTJSString EscapeC() const; // c-style string escape/unescaep
