...
namespace TJS {
    ...
    void tTJSExtendableObject::ExtendsClass(iTJSDispatch2 *global, const ttstr &classname) {
        tTJSVariant val;
        tjs_error er = global->PropGet(TJS_MEMBERMUSTEXIST, classname.c_str(), nullptr, &val, global);
        if(TJS_FAILED(er))
    ...
    tjs_error TJS_INTF_METHOD tTJSExtendableObject::FuncCall(tjs_uint32 flag, const tjs_char *membername,
    ...
    tjs_error TJS_INTF_METHOD tTJSExtendableObject::CreateNew(tjs_uint32 flag, const tjs_char *membername,
    ...
    tjs_error TJS_INTF_METHOD tTJSExtendableObject::PropGet(tjs_uint32 flag, const tjs_char *membername,
    ...
    tjs_error TJS_INTF_METHOD tTJSExtendableObject::PropSet(tjs_uint32 flag, const tjs_char *membername,
    ...
    tjs_error TJS_INTF_METHOD tTJSExtendableObject::IsInstanceOf(tjs_uint32 flag, const tjs_char *membername,
    ...
    tjs_error TJS_INTF_METHOD tTJSExtendableObject::GetCount(tjs_int *result, const tjs_char *membername,
    ...
    tjs_error TJS_INTF_METHOD tTJSExtendableObject::DeleteMember(tjs_uint32 flag, const tjs_char *membername,
                                                                 tjs_uint32 *hint, iTJSDispatch2 *objthis) {
    ...
    tjs_error TJS_INTF_METHOD tTJSExtendableObject::Invalidate(tjs_uint32 flag, const tjs_char *membername,
                                                               tjs_uint32 *hint, iTJSDispatch2 *objthis) {
    ...
    tjs_error TJS_INTF_METHOD tTJSExtendableObject::IsValid(tjs_uint32 flag, const tjs_char *membername,
                                                            tjs_uint32 *hint, iTJSDispatch2 *objthis) {
    ...
    tjs_error TJS_INTF_METHOD tTJSExtendableObject::Operation(tjs_uint32 flag, const tjs_char *membername,
                                                              tjs_uint32 *hint, tTJSVariant *result,
    ...
    tjs_error TJS_INTF_METHOD tTJSExtendableObject::NativeInstanceSupport(tjs_uint32 flag, tjs_int32 classid,
                                                                          iTJSNativeInstance **pointer) {
        tjs_error hr = inherited::NativeInstanceSupport(flag, classid, pointer);
        if(hr != TJS_S_OK && SuperClass != nullptr && flag == TJS_NIS_GETINSTANCE) {
            hr = SuperClass->NativeInstanceSupport(flag, classid, pointer);
        }
        return hr;
    }

    tjs_error TJS_INTF_METHOD tTJSExtendableObject::ClassInstanceInfo(tjs_uint32 flag, tjs_uint num,
                                                                      tTJSVariant *value) {
