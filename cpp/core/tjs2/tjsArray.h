...
namespace TJS {
    ...
    public:
        ...
        void operator+=(const tjs_char *string) { Append(string, (tjs_int)TJS_strlen(string)); }
    ...
    struct tTJSSaveStructuredDataCallback {
        virtual void SaveStructuredData(std::vector<iTJSDispatch2 *> &stack, iTJSTextWriteStream &stream,
    ...
    //---------------------------------------------------------------------------
    class tTJSArrayNI : public tTJSNativeInstance, public tTJSSaveStructuredDataCallback {
    ...
    public:
        ...
        tjs_error TJS_INTF_METHOD Construct(tjs_int numparams, tTJSVariant **params, iTJSDispatch2 *tjsobj);
    ...
    public:
        ...
        static void SaveStructuredDataForObject(iTJSDispatch2 *dsp, std::vector<iTJSDispatch2 *> &stack,
                                                iTJSTextWriteStream &stream, const ttstr &indentstr);

        static void SaveStructuredBinaryForObject(iTJSDispatch2 *dsp, std::vector<iTJSDispatch2 *> &stack,
    ...
    //---------------------------------------------------------------------------
    TJS_EXP_FUNC_DEF(iTJSDispatch2 *, TJSCreateArrayObject, (iTJSDispatch2 **classout = nullptr));
    //---------------------------------------------------------------------------
