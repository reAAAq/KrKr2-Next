...
extern const IID LIBID_TVPSndSysLib = {
    0xF09B2E87, 0x740A, 0x4AEA, { 0x90, 0xCB, 0xAE, 0x1C, 0x4E, 0xFD, 0x35, 0xF1 }
};

extern const IID IID_ITSSMediaBaseInfo = {
    0xB4C4239B, 0x7D27, 0x43CC, { 0x85, 0x23, 0x66, 0x95, 0x5B, 0xDF, 0x59, 0xDF }
};

extern const IID IID_ITSSStorageProvider = {
    0x7DD61993, 0x615D, 0x481D, { 0xB0, 0x60, 0xA9, 0xFD, 0x48, 0x39, 0x44, 0x30 }
};
...
extern const IID IID_ITSSWaveDecoder = {
    0x313864E2, 0x910E, 0x496F, { 0x8A, 0x6D, 0x43, 0x46, 0x5C, 0x10, 0x5B, 0x58 }
};
