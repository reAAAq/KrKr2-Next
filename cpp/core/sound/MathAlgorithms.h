 ...
 */
void DeinterleaveApplyingWindow(float *__restrict dest[], const float *__restrict src, float *__restrict win, int numch,
...
static inline __m128 VFast_arctan2_F4_SSE(__m128 y, __m128 x) {
    ...
    __m128 coeff_1_or_2 = _mm_xor_ps(_mm_and_ps(x_mask, PM128(TVP_VFASTATAN2_C1_XOR_C2)),
 ...
 *			丸めモードを再設定すること。
 */
static inline void SetRoundingModeToNearest_SSE() { _MM_SET_ROUNDING_MODE(_MM_ROUND_NEAREST); }
//---------------------------------------------------------------------------
...
static inline __m128 Wrap_Pi_F4_SSE2(__m128 v) {
    ...
    q = _mm_add_epi32(q,
                      _mm_and_si128(_mm_sub_epi32(_mm_setzero_si128(), _mm_and_si128(q, PM128I(TVP_V_I32_1))),
...
static inline __m128 Wrap_Pi_F4_SSE(__m128 v) {
    ...
    q0 = _mm_add_pi32(q0,
                      _mm_and_si64(_mm_sub_pi32(_mm_setzero_si64(), _mm_and_si64(q0, PM64(TVP_V_I32_1))),
                                   _mm_or_si64(_mm_srai_pi32(q0, 31), PM64(TVP_V_I32_1))));

    q1 = _mm_add_pi32(q1,
                      _mm_and_si64(_mm_sub_pi32(_mm_setzero_si64(), _mm_and_si64(q1, PM64(TVP_V_I32_1))),
 ...
 *実際に処理されるサンプル 数の総計はlen*numchになる)
 */
void DeinterleaveApplyingWindow_sse(float *__restrict dest[], const float *__restrict src, float *__restrict win,
