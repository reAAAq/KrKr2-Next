...
void TVPLoadMessage() {
    ...
    TJSObjectCountingMessageGroupByObjectTypeAndHistory.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_OBJECT_COUNTING_MESSAGE_GROUP_BY_OBJECT_TYPE_AND_HISTORY_CRLF]);
#else
    TJSObjectCountingMessageGroupByObjectTypeAndHistory.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_OBJECT_COUNTING_MESSAGE_GROUP_BY_OBJECT_TYPE_AND_HISTORY]);
#endif
    TJSObjectCountingMessageTJSGroupByObjectType.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_OBJECT_COUNTING_MESSAGE_TJSGROUP_BY_OBJECT_TYPE]);
#ifdef TJS_TEXT_OUT_CRLF
    ...
    TVPCannotConvertLayerTypeUsingGivenDirection.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_CONVERT_LAYER_TYPE_USING_GIVEN_DIRECTION]);
    ...
    TVPTransitionSourceAndDestinationMustHaveImage.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_TRANSITION_SOURCE_AND_DESTINATION_MUST_HAVE_IMAGE]);
    ...
    TVPHoldDestinationAlphaParameterIsNowDeprecated.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_HOLD_DESTINATION_ALPHA_PARAMETER_IS_NOW_DEPRECATED]);
    TVPCannotConnectMultipleWaveSoundBufferAtOnce.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_CONNECT_MULTIPLE_WAVE_SOUND_BUFFER_AT_ONCE]);
    ...
    TVPErrorInRetrievingSystemOnActivateOnDeactivate.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_ERROR_IN_RETRIEVING_SYSTEM_ON_ACTIVATE_ON_DEACTIVATE]);
    ...
    TVPInfoTryingToReadXp3VirtualFileSystemInformationFrom.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_TRYING_TO_READ_XP3VIRTUAL_FILE_SYSTEM_INFORMATION_FROM]);
    ...
    TVPTlgMalformedTagMissionColonAfterNameLength.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_TLG_MALFORMED_TAG_MISSION_COLON_AFTER_NAME_LENGTH]);
    ...
    TVPTlgMalformedTagMissionColonAfterVaueLength.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_TLG_MALFORMED_TAG_MISSION_COLON_AFTER_VAUE_LENGTH]);
    ...
    TVPConfigFailOriginalFileCannotBeRewritten.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CONFIG_FAIL_ORIGINAL_FILE_CANNOT_BE_REWRITTEN]);
    ...
    TVPInfoLoadingExecutableEmbeddedOptionsFailed.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_LOADING_EXECUTABLE_EMBEDDED_OPTIONS_FAILED]);
    TVPInfoLoadingExecutableEmbeddedOptionsSucceeded.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_LOADING_EXECUTABLE_EMBEDDED_OPTIONS_SUCCEEDED]);
    ...
    TVPInfoDataPathDoesNotExistTryingToMakeIt.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_DATA_PATH_DOES_NOT_EXIST_TRYING_TO_MAKE_IT]);
    ...
    TVPInfoSpecifiedOptionEarlierItemHasMorePriority.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_SPECIFIED_OPTION_EARLIER_ITEM_HAS_MORE_PRIORITY]);
    ...
    TVPCpuCheckFailureCpuFamilyOrLesserIsNotSupported.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CPU_CHECK_FAILURE_CPU_FAMILY_OR_LESSER_IS_NOT_SUPPORTED]);
    ...
    TVPLayerBitmapBufferUnderrunDetectedCheckYourDrawingCode.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_LAYER_BITMAP_BUFFER_UNDERRUN_DETECTED_CHECK_YOUR_DRAWING_CODE]);
    TVPLayerBitmapBufferOverrunDetectedCheckYourDrawingCode.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_LAYER_BITMAP_BUFFER_OVERRUN_DETECTED_CHECK_YOUR_DRAWING_CODE]);
    ...
    TVPWarningImageSizeTooLargeMayBeCannotCreateTexture.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_WARNING_IMAGE_SIZE_TOO_LARGE_MAY_BE_CANNOT_CREATE_TEXTURE]);
    ...
    TVPBasicDrawDeviceFailedToCreateDirect3DDevices.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_BASIC_DRAW_DEVICE_FAILED_TO_CREATE_DIRECT3DDEVICES]);
    TVPBasicDrawDeviceFailedToCreateDirect3DDevicesUnknownReason.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_BASIC_DRAW_DEVICE_FAILED_TO_CREATE_DIRECT3DDEVICES_UNKNOWN_REASON]);
    TVPBasicDrawDeviceTextureHasAlreadyBeenLocked.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_BASIC_DRAW_DEVICE_TEXTURE_HAS_ALREADY_BEEN_LOCKED]);
    ...
    TVPBasicDrawDeviceInfDirect3DDevicePresentFailed.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_BASIC_DRAW_DEVICE_INF_DIRECT3DDEVICE_PRESENT_FAILED]);
    TVPChangeDisplaySettingsFailedDispChangeRestart.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CHANGE_DISPLAY_SETTINGS_FAILED_DISP_CHANGE_RESTART]);
    TVPChangeDisplaySettingsFailedDispChangeBadFlags.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CHANGE_DISPLAY_SETTINGS_FAILED_DISP_CHANGE_BAD_FLAGS]);
    TVPChangeDisplaySettingsFailedDispChangeBadParam.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CHANGE_DISPLAY_SETTINGS_FAILED_DISP_CHANGE_BAD_PARAM]);
    TVPChangeDisplaySettingsFailedDispChangeFailed.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CHANGE_DISPLAY_SETTINGS_FAILED_DISP_CHANGE_FAILED]);
    TVPChangeDisplaySettingsFailedDispChangeBadMode.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CHANGE_DISPLAY_SETTINGS_FAILED_DISP_CHANGE_BAD_MODE]);
    TVPChangeDisplaySettingsFailedDispChangeNotUpdated.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CHANGE_DISPLAY_SETTINGS_FAILED_DISP_CHANGE_NOT_UPDATED]);
    TVPChangeDisplaySettingsFailedUnknownReason.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CHANGE_DISPLAY_SETTINGS_FAILED_UNKNOWN_REASON]);
    ...
    TVPBasicDrawDeviceFailedToCreateDirect3DDevice.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_BASIC_DRAW_DEVICE_FAILED_TO_CREATE_DIRECT3DDEVICE]);
    TVPBasicDrawDeviceFailedToCreateDirect3DDeviceUnknownReason.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_BASIC_DRAW_DEVICE_FAILED_TO_CREATE_DIRECT3DDEVICE_UNKNOWN_REASON]);
    ...
    TVPBasicDrawDeviceDoesNotSupporteLayerManagerMoreThanOne.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_BASIC_DRAW_DEVICE_DOES_NOT_SUPPORTE_LAYER_MANAGER_MORE_THAN_ONE]);
